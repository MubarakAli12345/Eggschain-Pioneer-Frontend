...
function CalendarApp(props)
{
    ...
    return (
        <div className={clsx(classes.root, "flex flex-col flex-auto relative")}>
            ...
            //     props.history.push('/apps/calendar/meetings')
            //     }
            // }
                onSelectSlot={slotInfo =>{
                    let SlotEvents = events.filter(function (e) {
                        return moment(e.start).format('MM/DD/YYYY') == moment(slotInfo.start).format('MM/DD/YYYY')
                    })
                    dispatch(
            ...
            {/* <FuseAnimate animation="transition.expandIn" delay={500}>
                <Fab
                    ...
                    onClick={() => handleMeetingFormStatus("New")}
                >
                    <Icon>add</Icon>
                </Fab>
            </FuseAnimate> */}
