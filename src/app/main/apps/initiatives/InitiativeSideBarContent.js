...
import { Avatar, Button, Divider, Icon, List, ListItem, ListItemText, Paper} from '@material-ui/core';
            ...
            <FuseAnimate animation="transition.slideLeftIn" delay={200}>
                <Paper className="rounded-0 shadow-none lg:rounded-8 lg:shadow-1">
                    ...
                    <div className="p-16 flex items-center justify-center">
                        ...
                        <Fab variant="extended" aria-label="Delete" color="primary" onClick={() => { handleMeetingFormStatus("New") }} className={"hoverEffect"}>
                    ...
                    <DialogTitle id="responsive-dialog-title">
                        <div className="flex justify-between h-48">
                            ...
                            <div className="flex items-center justify-end">
                                <CancelIcon style={{cursor:"pointer", color:"red"}} onClick={CloseMeetingForm}/>
                            </div>
                        </div>
                    </DialogTitle>
