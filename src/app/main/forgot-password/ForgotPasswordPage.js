...
function ForgotPasswordPage() {
	...
	return (
		...
		>
			<div style={{ marginTop: "100px" }} className="flex flex-col flex-grow-0 items-center text-white p-16 text-center md:p-128 md:items-start md:flex-shrink-0 md:flex-1 md:text-left">
	...
	<img className="w-128 mb-32" src="assets/images/logos/fuse.svg" alt="logo"/>
			...
			<FuseAnimate animation={{ translateX: [0, '100%'] }}>
				<Card elevation="0" className="w-full max-w-400 mx-auto m-16 md:m-0 loginPaper" square>
