          ...
          >
            <div className="p-16 pb-0 mr-8">
              ...
              <div className="flex flex-wrap mb-8">
                <span className={classes.cardContent}>
                  ...
                  <br />
                  <strong className={classes.labels}>
                    <a style={{ color: "#3C4252" }}>File Name:</a>
                  </strong>
                  <a
                    style={{
                      fontSize: "13px",
            ...
            <div className={classes.buttonHolder}>
              <Fab
                ...
                // onClick={() => {
                //   let storageAccountName = "eggschainpioneer";
                //   let res = `https://${storageAccountName}.blob.core.windows.net/files/${MeetingDetails.fileName}`;
                //   console.log("Res", res);
                //   return res;
                // }}
              ...
              >
                <a
                  href={`https://${storageAccountName}.blob.core.windows.net/files/${MeetingDetails.fileName}`}
                >
                  {" "}
                  Download{" "}
                </a>
