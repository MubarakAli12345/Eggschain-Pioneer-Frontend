        ...
        <React.Fragment>
            ...
            <Button className="h-64" onClick={userMenuClick}>
                ...
                <div className="hidden md:flex flex-col ml-12 items-start">
                    <Typography component="span" style={{color:"white"}} className="normal-case font-600 flex">
                        {user.data.fullName}
                    </Typography>
                </div>

                <Icon className="text-16 ml-12 hidden sm:flex" style={{color:"white"}} variant="action">keyboard_arrow_down</Icon>
            </Button>
