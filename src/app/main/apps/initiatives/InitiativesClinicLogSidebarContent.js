...
function InitiativeClinicLogSideBarContent(props) {
        ...
        >
          <DialogTitle id="responsive-dialog-title">
            <div className="flex justify-between h-48">
              <div className="flex items-center">New Blockchain Log</div>
...
export default InitiativeClinicLogSideBarContent;
